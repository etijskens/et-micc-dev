...
.PHONY: clean clean-test clean-pyc clean-build docs help uninstall f2py
.DEFAULT_GOAL := help
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source et-micc-dev -m pytest
	coverage report -m
	coverage html
...
#-------------------------------------------------------------------------------
# Install package et_micc_dev in the current Python
# environment.
install: clean dist
	pip install dist/$(module_name)-$(version)-py3-none-any.whl

#-------------------------------------------------------------------------------
# Uninstall package et_micc_dev from current Python environment
uninstall:
